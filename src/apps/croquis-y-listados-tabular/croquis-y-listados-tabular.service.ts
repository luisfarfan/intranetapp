...
export class CroquisylistadostabularService {
    ...
    private tablaUrlAux: string = 'http://172.18.1.40:8000/crotabrecargaTabla01/';
    private tablaUrlAux2: string = 'http://172.18.1.40:8000/crotabrecargaTabla02/';
    private tablaUrlZip: string = 'http://172.18.1.40:8000/crotabdescargarPdf/';
